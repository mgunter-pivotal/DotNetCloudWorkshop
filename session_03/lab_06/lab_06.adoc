...
----
+
Since we've added new dependencies, if you are using Eclipse/RAD or IntelliJ, you'll need to re-run +./gradlew idea+ or +./gradlew eclipse+ to have them added to the IDE classpath.
