...
. Note: the version of the .net framework within the web.config file may need to be changed from 4.5.2 to 4.5
+
----
...
C:\Users\Matt\git_projects\DotNetCloudWorkshop\session_01\lab_01\uk-towns-dotnet>cf push uktowns02 -s windows2012R2 -b binary_buildpack
