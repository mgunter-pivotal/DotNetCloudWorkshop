...
. Go to the https://docs.google.com/spreadsheets/d/1WDr2GYVq9JsdZK35o0kqQAvp4KsPn6RIRwJqKuKfF0o/edit?usp=sharing[user info spreadsheet] and assign yourself a Pivotal Cloud Foundry user for the workshop.
