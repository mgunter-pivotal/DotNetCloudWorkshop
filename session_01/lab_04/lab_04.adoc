...
Take a look at the events that have transpired so far for our deployment of `cf-scale-dotnet`:

====
----
$ cf events cf-scale-dotnet
Getting events for app cf-scale-dotnet in org oreilly-class / space instructor as mstine@pivotal.io...
...
+
----
$ cf stop cf-scale-dotnet
Stopping app cf-scale-dotnet in org oreilly-class / space instructor as mstine@pivotal.io...
OK
----
...
+
----
$ cf start cf-scale-dotnet
Starting app cf-scale-dotnet in org oreilly-class / space instructor as mstine@pivotal.io...
...
. Let's view recent log messages for `cf-scale-dotnet`:
+
----
$ cf logs cf-scale-dotnet --recent
----
+
...
+
----
$ cf create-user-provided-service cf-scale-dotnet-logs -l syslog://logs2.papertrailapp.com:43882
Creating user provided service cf-scale-dotnet-logs in org oreilly-class / space instructor as mstine@pivotal.io...
OK
----
...
+
----
$ cf bind-service cf-scale-dotnet cf-scale-dotnet-logs
Binding service cf-scale-dotnet-logs to app cf-scale-dotnet in org oreilly-class / space instructor as mstine@pivotal.io...
OK
...
. If you don't have one already running, start a log tail for `cf-scale-dotnet`:
+
----
$ cf logs cf-scale-dotnet
----
...
+
image::../../Common/images/cf-scale-dotnet-kill.png[]
...
time                          event                 actor               description
2015-02-13T17:17:57.00-0600   app.crash             cf-scale-dotnet       index: 0, reason: CRASHED, exit_description: app instance exited, exit_status: 1
----
...
====
----
2015-02-13T17:18:14.67-0600 [CELL/0]     OUT Creating container. <1>
...
+
image::../../Common/images/cf-scale-dotnet-healed.png[]
...
. Delete the `cf-scale-dotnet` application:
+
----
$ cf d cf-scale-dotnet

Really delete the app cf-scale-dotnet?> y
Deleting app cf-scale-dotnet in org oreilly-class / space instructor as mstine@pivotal.io...
'OK
----

. Delete the `cf-scale-dotnet-logs` service:
+
----
$ cf ds cf-scale-dotnet-logs

Really delete the service cf-scale-dotnet-logs?> y
Deleting service cf-scale-dotnet-logs in org oreilly-class / space instructor as mstine@pivotal.io...
OK
----
