...
. The rest of the labs will ask you to edit portions of these two applications.  You may generate eclipse or idea projects using `./gradlew eclipse` or `./gradlew idea` or you can simply edit the files with the editor of your choice. We will not be making a lot of changes.
+
